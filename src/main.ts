...
if (customElements.get('v-badge')) {
  ...
  import('./elements/context-menu/context-menu.svelte');
  import('./elements/context-menu/context-menu-item.svelte');
  import('./elements/context-menu/context-menu-separator.svelte');
