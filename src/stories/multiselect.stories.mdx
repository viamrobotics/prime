...
<Meta
  ...
  argTypes={{
    ...
    options: {
      description:
        'The list of options that can be selected from, separated by commas',
      table: {
        defaultValue: { summary: '' },
        type: { summary: 'string' },
      },
    ...
    'on:clear-all-click': {
      description:
        'Event fired when "Clear All" is pressed and values are cleared',
    },
  }}
/>
...
<Canvas>
  ...
  >
    {({ label, tooltip, value, options, state, message }) => `
      <v-multiselect
        label='${label}'
        options='${options}'
        value='${value}'
...
<Canvas>
  ...
  >
    {({ label, options, value, state, tooltip }) => `
      <v-multiselect
        label='${label}'
        options='${options}'
        value='${value}'
