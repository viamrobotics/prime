...
test('Renders a gray badge if the variant is specified as gray', async ({ page }) => {
...
test('Renders a gray badge if the variant is not specified', async ({ page }) => {
...
test('Renders a green badge if the variant is specified as green', async ({ page }) => {
...
test('Renders an orange badge if the variant is specified as orange', async ({ page }) => {
...
test('Renders a red badge if the variant is specified as red', async ({ page }) => {
