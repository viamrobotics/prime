...
test('Renders notify element with appropriate title text, message text, if those attributes are specified', async ({ page }) => {
...
test('Renders notify with default style if no variant is specified', async ({ page }) => {
...
test('Renders notify with error style if the variant is set to error', async ({ page }) => {
...
test('Renders notify with warning style if the variant is set to warning', async ({ page }) => {
...
test('Renders notify with success style if the variant is set to success', async ({ page }) => {
...
test('Renders notify with info style if the variant is set to info', async ({ page }) => {
...
test('Renders notify with gray background if the background attribute is set to gray', async ({ page }) => {
...
test('Renders notify with white background if the background attribute is set to white', async ({ page }) => {
