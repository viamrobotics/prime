...
test('Renders an icon if name attribute is specified as a valid v-icon', async ({ page }) => {
    await expect(page.getByTestId("icon-default-valid")).toBeVisible()
});

test('Does not render an icon if name attribute is specified as an invalid v-icon', async ({ page }) => {
    await expect(page.getByTestId("icon-default-invalid")).not.toBeVisible()
});

test('Renders and icon as extra small if size attribute is specified as xs', async ({ page }) => {
...
test('Renders and icon as small if size attribute is specified as sm', async ({ page }) => {
...
test('Renders and icon as the base size if size attribute is specified as base', async ({ page }) => {
...
test('Renders and icon as the large size if size attribute is specified as lg', async ({ page }) => {
...
test('Renders and icon as the extra large size if size attribute is specified as xl', async ({ page }) => {
...
test('Renders and icon as the 2xl size if size attribute is specified as 2xl', async ({ page }) => {
...
test('Renders and icon as the 3xl size if size attribute is specified as 3xl', async ({ page }) => {
...
test('Renders and icon as the 4xl size if size attribute is specified as 4xl', async ({ page }) => {
