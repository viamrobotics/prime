var E=Object.defineProperty;var p=(o,t)=>E(o,"name",{value:t,configurable:!0});import"./jsx-runtime.b0e74a22.js";import{c as n,A as w,M as D,C as s,S as u}from"./Props.d85684c5.js";import"./iframe.33511a8d.js";import"./es.map.constructor.155b6f9d.js";import"./es.number.to-fixed.2c8cec74.js";function m(){return m=Object.assign?Object.assign.bind():function(o){for(var t=1;t<arguments.length;t++){var e=arguments[t];for(var l in e)Object.prototype.hasOwnProperty.call(e,l)&&(o[l]=e[l])}return o},m.apply(this,arguments)}p(m,"_extends");const V={},M="wrapper";function C({components:o,...t}){return n(M,m({},V,t,{components:o,mdxType:"MDXLayout"}),n(D,{title:"Elements/Input",parameters:{actions:{handles:["input"]}},argTypes:{type:{description:"The input type",control:"select",options:["text","email","number","date","time","datetime-local"],table:{defaultValue:{summary:"text"}}},label:{description:"The input label",table:{defaultValue:{summary:""}}},placeholder:{description:"The input placeholder text",table:{defaultValue:{summary:""}}},value:{description:"The starting input value",table:{defaultValue:{summary:""}}},step:{description:"For number inputs, the increment step",control:"number",table:{defaultValue:{summary:1}}},labelposition:{description:"The label position",control:{type:"select"},options:["top","left"],table:{defaultValue:{summary:"top"}}},"on:input":{description:"Event fired whenever the input changes"}},mdxType:"Meta"}),n("h1",null,"Input"),n("p",null,"Used for all text single-line user inputs."),n(s,{mdxType:"Canvas"},n(u,{name:"Text",args:{type:"text",label:"Favorite soup",placeholder:"Enter soup here",value:"Minestrone"},mdxType:"Story"},({type:e,label:l,placeholder:a,value:r})=>`
    ...
    `)),n(s,{mdxType:"Canvas"},n(u,{name:"Message",args:{label:"Board",value:"",message:"some message",state:"info"},mdxType:"Story"},({label:e,value:l,message:a,state:r})=>`
      <v-input
        ...
        state='${r}'
      />
    `)))}p(C,"MDXContent");C.isMDXComponent=!0;const b=p(({type:o,label:t,placeholder:e,value:l})=>`
      <v-input
        type='${o}'
        label='${t}'
        placeholder='${e}'
  ...
  value
    ...
    \``}};const g=p(({type:o,label:t,placeholder:e,value:l})=>`
      <v-input
        ...
        value='${l}'
      />
    `,"noLabel");g.storyName="No label";g.args={type:"number",placeholder:"0",value:""};g.parameters={storySource:{source:`({
  type,
  label,
  placeholder,
  value
      ...
      <v-input
        ...
        value='\${value}'
      />
    \``}};const T=p(({type:o,label:t,placeholder:e,value:l,labelPosition:a})=>`
      <v-input
        label='${t}'
        placeholder='${e}'
        value='${l}'
        labelposition='${a}'
      />
    `,"leftLabel");T.storyName="Left label";T.args={label:"Whose soup?",placeholder:"Enter name",value:"",labelPosition:"left"};T.parameters={storySource:{source:`({
  type,
  label,
  placeholder,
  value,
  ...
  value
      ...
      <v-input
        ...
        value='\${value}'
      />
    \``}};const S=p(({label:o,tooltip:t,value:e})=>`
      <v-input
        label='${o}'
        tooltip='${t}'
        value='${e}'
      />
    `,"tooltip");S.storyName="Tooltip";S.args={label:"Favorite soup",value:"Cereal",tooltip:"Unsupported soup type. Eat at your own risk. Or eat a recognized soup instead."};S.parameters={storySource:{source:`({
  label,
  tooltip,
  value
}) => \`
      <v-input
        ...
        value='\${value}'
      />
    \``}};const L=p(({label:o,tooltip:t,value:e,disabled:l})=>`
      <v-input
        label='${o}'
        disabled='${l}'
        tooltip='${t}'
        value='${e}'
      />
    `,"disabled");L.storyName="Disabled";L.args={label:"Board",value:"",tooltip:"Create a board component first.",disabled:!0};L.parameters={storySource:{source:`({
  label,
  tooltip,
  value,
  disabled
      ...
      <v-input
        ...
        value='\${value}'
      />
    \``}};const N=p(({label:o,value:t,message:e,state:l})=>`
      <v-input
        label='${o}'
        value='${t}'
        message='${e}'
        state='${l}'
      />
    `,"message");N.storyName="Message";N.args={label:"Board",value:"",message:"some message",state:"info"};N.parameters={storySource:{source:`({
  label,
  value,
  message,
  state
      ...
      <v-input
        ...
        state='\${state}'
      />
    \``}};const d={title:"Elements/Input",parameters:{actions:{handles:["input"]}},argTypes:{type:{description:"The input type",control:"select",options:["text","email","number","date","time","datetime-local"],table:{defaultValue:{summary:"text"}}},label:{description:"The input label",table:{defaultValue:{summary:""}}},placeholder:{description:"The input placeholder text",table:{defaultValue:{summary:""}}},value:{description:"The starting input value",table:{defaultValue:{summary:""}}},step:{description:"For number inputs, the increment step",control:"number",table:{defaultValue:{summary:1}}},labelposition:{description:"The label position",control:{type:"select"},options:["top","left"],table:{defaultValue:{summary:"top"}}},"on:input":{description:"Event fired whenever the input changes"}},includeStories:["text","number","integer","date","time","datetimeLocal","noLabel","leftLabel","leftLabelWithNumber","readonly","tooltip","disabled","message"]},P={Text:"text",Number:"number",Integer:"integer",Date:"date",Time:"time","Datetime Local":"datetimeLocal","No label":"noLabel","Left label":"leftLabel","Left label with number":"leftLabelWithNumber",Readonly:"readonly",Tooltip:"tooltip",Disabled:"disabled",Message:"message"};d.parameters=d.parameters||{};d.parameters.docs={...d.parameters.docs||{},page:()=>n(w,{mdxStoryNameToKey:P,mdxComponentAnnotations:d},n(C,null))};const j=["text","number","integer","date","time","datetimeLocal","noLabel","leftLabel","leftLabelWithNumber","readonly","tooltip","disabled","message"];export{j as __namedExportsOrder,v as date,h as datetimeLocal,d as default,L as disabled,c as integer,T as leftLabel,f as leftLabelWithNumber,N as message,g as noLabel,y as number,x as readonly,b as text,$ as time,S as tooltip};
//# sourceMappingURL=input.stories.e4c049e0.js.map
