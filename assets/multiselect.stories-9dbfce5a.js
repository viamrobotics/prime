...
`,t.exports.jsx(p,{children:t.exports.jsx(c,{name:"Default",args:{label:"Default multiselect",options:"happy, sad, angry"},children:({label:e,options:a})=>`
      <v-multiselect
        label='${e}'
        options='${a}'
      />
...
`,t.exports.jsx(p,{children:t.exports.jsx(c,{name:"With tooltip",args:{label:"With tooltip",options:"Option 1, Option 2, Option 3",value:"Option",tooltip:"Warning: these options may not be your only options.",state:"warn"},children:({label:e,options:a,value:s,tooltip:r,state:u})=>`
      ...
      />
    `})}),`
`,t.exports.jsx(p,{children:t.exports.jsx(c,{name:"With prefix",args:{label:"Options with prefixes",options:W,placeholder:"Select...",prefix:"true"},children:({label:e,options:a,placeholder:s,prefix:r})=>`
      <v-multiselect
        label='${e}'
        options='${a}'
        placeholder='${s}'
...
`,t.exports.jsx(p,{children:t.exports.jsx(c,{name:"Not clearable",args:{label:"Not clearable",options:"hello, hi, yo, halo",value:"hi, halo",clearable:"false"},children:({label:e,options:a,clearable:s,value:r})=>`
      ...
      />
    `})}),`
`,t.exports.jsx(p,{children:t.exports.jsx(c,{name:"Error",args:{label:"Board",value:"",state:"error",options:"hello, hi, yo, halo",message:"Something went wrong."},children:({label:e,tooltip:a,value:s,options:r,state:u,message:N})=>`
      <v-multiselect
        label='${e}'
        options='${r}'
        value='${s}'
  ...
  state
    ...
    \``}};const g=({label:o,options:l,placeholder:n,prefix:i})=>`
      <v-multiselect
        ...
        prefix='${i}'
      />
    `;g.storyName="With prefix";g.args={label:"Options with prefixes",options:W,placeholder:"Select...",prefix:"true"};g.parameters={storySource:{source:`({
  label,
  options,
  placeholder,
  prefix
