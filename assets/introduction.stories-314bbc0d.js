...
`;function l(t={}){const{wrapper:r}=Object.assign({},i(),t.components);return r?e.jsx(r,{...t,children:e.jsx(s,{})}):s();function s(){return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Docs/Introduction"}),`
`,e.jsx(a,{children:m})]})}}const c=()=>{throw new Error("Docs-only story")};c.parameters={docsOnly:!0};const n={title:"Docs/Introduction",tags:["stories-mdx"],includeStories:["__page"]};n.parameters=n.parameters||{};n.parameters.docs={...n.parameters.docs||{},page:l};const M=["__page"];export{M as __namedExportsOrder,c as __page,n as default};
//# sourceMappingURL=introduction.stories-314bbc0d.js.map
