import"./jsx-runtime.59ebbf32.js";import{c as i,A as b,M as j,C as s,S as m}from"./Props.2a62f1e9.js";import"./iframe.0ed83d26.js";import"./es.map.constructor.f61e0239.js";import"./es.number.to-fixed.07b3f5b4.js";const $=`
{ 
  "foo": "bar",
  "some": "thing",
  "yes": true,
...
`.trim();function u(){return u=Object.assign?Object.assign.bind():function(d){for(var r=1;r<arguments.length;r++){var t=arguments[r];for(var a in t)Object.prototype.hasOwnProperty.call(t,a)&&(d[a]=t[a])}return d},u.apply(this,arguments)}const w={},C="wrapper";function T({components:d,...r}){return i(C,u({},w,r,{components:d,mdxType:"MDXLayout"}),i(j,{title:"Elements/Code Editor",parameters:{actions:{handles:["blur","destroy","input","resize","update-markers","update-model"]}},argTypes:{value:{description:"The content for the editor",table:{defaultValue:{summary:""}}},language:{control:{type:"select"},options:["json","javascript","typescript","python","go"],description:"The language to use for syntax highlighting",table:{defaultValue:{summary:"json"}}},theme:{description:"The `monaco` theme to use",control:{type:"select"},options:["vs","vs-dark"],table:{defaultValue:{summary:"vs"}}},readonly:{description:"Determines if the editor should be readonly or editable",control:{type:"select"},options:["true","false"],table:{defaultValue:{summary:"false"}}},minimap:{description:"Determines if the editor should render the minimap",control:{type:"select"},options:["true","false"],table:{defaultValue:{summary:"false"}}},uri:{description:"When defined, is passed to `window.monaco.editor.createModel`",control:{type:"text"},table:{defaultValue:{summary:""}}}},mdxType:"Meta"}),i("h1",null,"Code Editor"),i("p",null,"Uses ",i("inlineCode",{parentName:"p"},"monaco")," for syntax-highlighting."),i(s,{mdxType:"Canvas"},i(m,{name:"JSON editor",args:{language:"json",value:$},mdxType:"Story"},({value:t,language:a,theme:n,readonly:e,minimap:l,uri:o})=>`
  ...
  uri
    ...
    \``}};const p={title:"Elements/Code Editor",parameters:{actions:{handles:["blur","destroy","input","resize","update-markers","update-model"]}},argTypes:{value:{description:"The content for the editor",table:{defaultValue:{summary:""}}},language:{control:{type:"select"},options:["json","javascript","typescript","python","go"],description:"The language to use for syntax highlighting",table:{defaultValue:{summary:"json"}}},theme:{description:"The `monaco` theme to use",control:{type:"select"},options:["vs","vs-dark"],table:{defaultValue:{summary:"vs"}}},readonly:{description:"Determines if the editor should be readonly or editable",control:{type:"select"},options:["true","false"],table:{defaultValue:{summary:"false"}}},minimap:{description:"Determines if the editor should render the minimap",control:{type:"select"},options:["true","false"],table:{defaultValue:{summary:"false"}}},uri:{description:"When defined, is passed to `window.monaco.editor.createModel`",control:{type:"text"},table:{defaultValue:{summary:""}}}},includeStories:["jsonEditor","javaScriptEditor","typeScriptEditor","pythonEditor","goEditor"]},V={"JSON editor":"jsonEditor","JavaScript editor":"javaScriptEditor","TypeScript editor":"typeScriptEditor","Python editor":"pythonEditor","Go editor":"goEditor"};p.parameters=p.parameters||{};p.parameters.docs={...p.parameters.docs||{},page:()=>i(b,{mdxStoryNameToKey:V,mdxComponentAnnotations:p},i(T,null))};const P=["jsonEditor","javaScriptEditor","typeScriptEditor","pythonEditor","goEditor"];export{P as __namedExportsOrder,p as default,v as goEditor,h as javaScriptEditor,g as jsonEditor,c as pythonEditor,y as typeScriptEditor};
//# sourceMappingURL=code-editor.stories.985b8db3.js.map
