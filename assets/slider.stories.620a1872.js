import"./index.5c7752e3.js";import{c as t,A as y,M as $,C as o,S as d}from"./Props.ed0d98fa.js";import"./iframe.175d2946.js";function l(){return l=Object.assign?Object.assign.bind():function(r){for(var a=1;a<arguments.length;a++){var e=arguments[a];for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(r[n]=e[n])}return r},l.apply(this,arguments)}const v={},f="wrapper";function p({components:r,...a}){return t(f,l({},v,a,{components:r,mdxType:"MDXLayout"}),t($,{title:"Elements/Slider",parameters:{actions:{handles:["input","click"]}},argTypes:{min:{description:"The minimum value",control:"number",defaultValue:"",table:{defaultValue:{summary:""}}},max:{description:"The maxiumum value",control:"number",defaultValue:"",table:{defaultValue:{summary:""}}}},mdxType:"Meta"}),t("h1",null,"Radio"),t("p",null,"For user triggered actions"),t(o,{mdxType:"Canvas"},t(d,{name:"Slider",args:{min:0,max:100,step:10},mdxType:"Story"},({min:e,max:n,step:s})=>`
      <v-slider
        min="${e}"
        max="${n}"
        step="${s}"
