import"./jsx-runtime.df297713.js";import{c as n,A as b,M as h,C as i,S as l}from"./Props.60be290b.js";import"./iframe.55ee7d4e.js";function p(){return p=Object.assign?Object.assign.bind():function(s){for(var r=1;r<arguments.length;r++){var e=arguments[r];for(var a in e)Object.prototype.hasOwnProperty.call(e,a)&&(s[a]=e[a])}return s},p.apply(this,arguments)}const S={},T="wrapper";function f({components:s,...r}){return n(T,p({},S,r,{components:s,mdxType:"MDXLayout"}),n(h,{title:"Elements/Slider",parameters:{actions:{handles:["input","click"]}},argTypes:{min:{description:"The minimum value",control:"number",table:{defaultValue:{summary:0}}},max:{description:"The maxiumum value",control:"number",table:{defaultValue:{summary:100}}},step:{description:"An optional discrete step between values",control:"number",table:{defaultValue:{summary:1}}},value:{description:"An optional starting value",control:"number",table:{defaultValue:{summary:"(min + max) / 2"}}},label:{description:"An optional label",table:{defaultValue:{summary:""}}},suffix:{description:"An optional suffix",table:{defaultValue:{summary:""}}},"on:input":{description:"Event fired when an option is selected"}},mdxType:"Meta"}),n("h1",null,"Slider"),n("p",null,"For user triggered actions"),n(i,{mdxType:"Canvas"},n(l,{name:"Slider",args:{min:0,max:100,step:10},mdxType:"Story"},({min:e,max:a,step:t})=>`
    ...
    `)),n(i,{mdxType:"Canvas"},n(l,{name:"Range",args:{min:0,max:100,start:10,end:90,step:10},mdxType:"Story"},({min:e,max:a,step:t,start:m,end:u})=>`
      ...
      />
    `)),n(i,{mdxType:"Canvas"},n(l,{name:"Min range",args:{range:"min",min:0,max:100,value:30,step:10},mdxType:"Story"},({range:e,min:a,max:t,step:m,value:u})=>`
      <v-slider
        range='${e}'
        max='${t}'
        step='${m}'
        value='${u}'
      />
    `)),n(i,{mdxType:"Canvas"},n(l,{name:"Max range",args:{range:"max",min:0,max:100,value:70,step:10},mdxType:"Story"},({range:e,min:a,max:t,step:m,value:u})=>`
      <v-slider
        range='${e}'
        max='${t}'
        step='${m}'
  ...
  step
      ...
      <v-slider
        ...
        step='\${step}'
      />
    \``}};const o={title:"Elements/Slider",parameters:{actions:{handles:["input","click"]}},argTypes:{min:{description:"The minimum value",control:"number",table:{defaultValue:{summary:0}}},max:{description:"The maxiumum value",control:"number",table:{defaultValue:{summary:100}}},step:{description:"An optional discrete step between values",control:"number",table:{defaultValue:{summary:1}}},value:{description:"An optional starting value",control:"number",table:{defaultValue:{summary:"(min + max) / 2"}}},label:{description:"An optional label",table:{defaultValue:{summary:""}}},suffix:{description:"An optional suffix",table:{defaultValue:{summary:""}}},"on:input":{description:"Event fired when an option is selected"}},includeStories:["slider","range","minRange","maxRange","withSuffix","withValue","withLabel"]},w={Slider:"slider",Range:"range","Min range":"minRange","Max range":"maxRange","With suffix":"withSuffix","With value":"withValue","With label":"withLabel"};o.parameters=o.parameters||{};o.parameters.docs={...o.parameters.docs||{},page:()=>n(b,{mdxStoryNameToKey:w,mdxComponentAnnotations:o},n(f,null))};const A=["slider","range","minRange","maxRange","withSuffix","withValue","withLabel"];export{A as __namedExportsOrder,o as default,c as maxRange,$ as minRange,d as range,x as slider,g as withLabel,v as withSuffix,y as withValue};
//# sourceMappingURL=slider.stories.16fc3674.js.map
