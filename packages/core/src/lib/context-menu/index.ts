...
export { default as FloatingMenu } from './floating-menu.svelte';
export type { FloatingMenuPlacement } from './floating-style';
export type { ContextMenuItemVariant } from './variants';
