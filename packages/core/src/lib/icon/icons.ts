...
export const paths: Record<string, IconPath> = {
  ...
  'viam-mixed-part-status': [
    {
      path: 'M8 7.333c-.733 0-1.333.6-1.333 1.334C6.667 9.4 7.267 10 8 10s1.333-.6 1.333-1.333c0-.734-.6-1.334-1.333-1.334Zm4 1.334c0-2.207-1.793-4-4-4s-4 1.793-4 4c0 1.48.807 2.766 2 3.46l.667-1.16a2.664 2.664 0 0 1-1.334-2.3 2.666 2.666 0 1 1 5.334 0c0 .986-.54 1.833-1.334 2.3l.667 1.16c1.193-.694 2-1.98 2-3.46Z',
    },
    {
      path: 'M8 2a6.67 6.67 0 0 0-6.667 6.667 6.66 6.66 0 0 0 3.327 5.766l.667-1.153A5.332 5.332 0 0 1 8 3.333a5.329 5.329 0 0 1 2.667 9.947l.667 1.153a6.651 6.651 0 0 0 3.333-5.766A6.67 6.67 0 0 0 8 2Z',
      opacity: 0.5,
    },
  ],
  'viam-ml-model':
