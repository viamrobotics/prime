...
describe('Slider', () => {
  ...
  it('Displays start and and end values', () => {
    ...
    expect(eleFirst).toBeVisible();
    // Opacity isn't working
    // const eleFirstOpacity = getComputedStyle(eleFirst).opacity;
    // expect(Number.parseFloat(eleFirstOpacity)).toBeCloseTo(1);
  });
  ...
  it('Restricts slider value to intervals of size step', () => {
    // TODO
  });
