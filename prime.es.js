...
function create_each_block$4(key_1, ctx) {
	...
	let t1;
	let if_block_anchor;
	let if_block = /*index*/ ctx[4] !== /*parsedCrumbs*/ ctx[0].length - 1 && create_if_block$4();
...
function create_fragment$5(ctx) {
	...
	let if_block1 = /*type*/ ctx[1] === 'number' && create_if_block$2(ctx);
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			toggle_class(span, "translate-x-5", /*on*/ ctx[5]);
			...
			attr(button_1, "class", button_1_class_value = cx('relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-green/100 rounded-full cursor-pointer motion-safe:transition-colors ease-in-out duration-200 focus:outline-none', { 'bg-green/80': /*on*/ ctx[5] }));
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(button_1, "click", /*handleClick*/ ctx[6]);
				mounted = true;
			}
		},
		p(ctx, [dirty]) {
			...
			if (dirty & /*on*/ 32 && button_1_class_value !== (button_1_class_value = cx('relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-green/100 rounded-full cursor-pointer motion-safe:transition-colors ease-in-out duration-200 focus:outline-none', { 'bg-green/80': /*on*/ ctx[5] }))) {
				attr(button_1, "class", button_1_class_value);
			}
