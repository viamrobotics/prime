...
function ai(e) {
  ...
  return {
    c() {
      t = k("div"), n = k("div"), n.innerHTML = '<slot name="target"></slot>', r = Y(), i = k("div"), o = k("slot"), this.c = V, u(n, "class", "inline-block w-full"), u(o, "name", "content"), u(i, "class", l = H("absolute z-10", {
        "left-0": e[1],
        "right-0": e[1],
        "overflow-hidden": e[1],
        invisible: !e[2]
