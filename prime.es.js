...
function create_fragment$a(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*variant*/ ctx[2] === 'error') return create_if_block$6;
		if (/*variant*/ ctx[2] === 'warning') return create_if_block_1$2;
		if (/*variant*/ ctx[2] === 'success') return create_if_block_2$1;
		if (/*variant*/ ctx[2] === 'info') return create_if_block_3$1;
	}
