...
function Sn(t) {
  ...
  return {
    c() {
      e = w("p"), n = $(t[1]), u(e, "class", i = T("text-xs", { "text-black/50": t[6] }));
    },
    m(l, r) {
      O(l, e, r), m(e, n);
    },
    p(l, r) {
      r & 2 && te(n, l[1]), r & 64 && i !== (i = T("text-xs", { "text-black/50": l[6] })) && u(e, "class", i);
    },
    d(l) {
      l && j(e);
    }
...
function Yr(t) {
  ...
  return {
    c() {
      e = w("label"), n = w("div"), s && s.c(), i = X(), a && a.c(), l = X(), r = w("div");
      for (let d = 0; d < f.length; d += 1)
        f[d].c();
      this.c = F, u(n, "class", "flex items-center gap-1.5"), u(r, "class", "flex flex-nowrap"), u(e, "class", o = T("flex gap-1.5", {
        "flex-col": t[2] === "top",
        "flex-row": t[2] === "left"
      }));
    },
    m(d, b) {
      O(d, e, b), m(e, n), s && s.m(n, null), m(n, i), a && a.m(n, null), m(e, l), m(e, r);
    ...
    p(d, [b]) {
      if (d[1] ? s ? s.p(d, b) : (s = Sn(d), s.c(), s.m(n, i)) : s && (s.d(1), s = null), d[3] ? a ? a.p(d, b) : (a = Mn(d), a.c(), a.m(n, null)) : a && (a.d(1), a = null), b & 225) {
        ...
        for (h = 0; h < c.length; h += 1) {
          const g = En(d, c, h);
          f[h] ? f[h].p(g, b) : (f[h] = On(g), f[h].c(), f[h].m(r, null));
        }
        for (; h < f.length; h += 1)
          f[h].d(1);
        f.length = c.length;
