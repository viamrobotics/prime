...
// (17:0) {#each parsedOptions as option}
function create_each_block$3(ctx) {
	...
	return {
		...
		p(new_ctx, dirty) {
			...
			if (dirty & /*parsedOptions, selected*/ 5 && button_1_class_value !== (button_1_class_value = cx('border-y border-l last:border-r border-black px-2 py-1 text-sm', {
				'bg-white': /*option*/ ctx[7] !== /*selected*/ ctx[0],
				'bg-black text-white': /*option*/ ctx[7] === /*selected*/ ctx[0]
			}))) {
...
function create_fragment$4(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			if (dirty & /*cx, parsedOptions, selected, button, handleClick*/ 15) {
