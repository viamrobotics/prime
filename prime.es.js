  ...
  return {
    c() {
      e = v("div"), n = v("div"), i = v("div"), M && M.c(), r = B(), o = v("slot"), l = B(), s = v("div"), a = v("slot"), c = B(), u = v("v-icon"), h = B(), m = v("div"), b = v("slot"), this.c = N, f(o, "name", "title"), f(i, "class", "flex flex-wrap gap-x-3 gap-y-1 items-center"), f(a, "name", "header"), U(u, "class", d = D("transition-transform duration-200", {
        "rotate-0": !t[0],
        "rotate-180": t[0]
      })), U(u, "name", "chevron-down"), U(u, "size", "2xl"), f(s, "class", "h-full flex items-center gap-3"), f(n, "class", "w-full py-2 px-4 flex flex-reverse items-baseline justify-between border text-black border-black bg-white cursor-pointer"), f(m, "class", y = D("bg-white text-black overflow-hidden transition-all duration-500", {
        "max-h-0": !t[0],
        "max-h-fit": t[0]
